...
namespace WebApplication6.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            if (User.Identity.GetUserName()== "fzp.fzp@msa.hinet.net") { return Redirect("Gas/Index"); }
            if (User.Identity.GetUserName() == "wttssh@yahoo.com.tw") { return Redirect("Gas/KaoIndex"); }
